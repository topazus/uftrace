...
install: all
	...
	$(Q)$(INSTALL) -d -m 755 $(DESTDIR)$(prefix)/share/bash-completion/completions
...
ifneq ($(findstring HAVE_LIBPYTHON, $(COMMON_CFLAGS)), )
	...
	$(Q)$(INSTALL) -m 644 $(srcdir)/misc/bash-completion.sh $(DESTDIR)$(prefix)/share/bash-completion/completions/uftrace
...
ifneq ($(findstring HAVE_LIBPYTHON, $(COMMON_CFLAGS)), )
	...
	$(Q)$(RM) $(DESTDIR)$(prefix)/share/bash-completion/completions/uftrace
